...
public class VariableDeclaratiom {
	...
	public static void main(String[] args) {
		...
		// 3 way
		byte num1, num2, num3;//if variable is of the same type, we can declare all in 1 line 
		num1=10;
		num2=20;
		num3=30;
		System.out.println(num3);
		
		//what wull be the output?
